...
pub const LINK_HEADLESS_LINUX_SUPPORT: &str = "https://github.com/rustdesk/rustdesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["r18.wooge123.top"];
